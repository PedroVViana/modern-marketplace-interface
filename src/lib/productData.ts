...
export const products: Product[] = [
  ...
  {
    id: '9',
    title: 'Cama de Casal - Madeira Maciça com Colchão',
    price: 1750,
    location: 'São Paulo, SP',
    image: 'https://images.unsplash.com/photo-1617104678098-de229db51175?q=80&w=500',
    description: 'Cama de casal em madeira maciça com design moderno e acabamento em verniz natural. Acompanha colchão ortopédico em ótimo estado. Dimensões: 200cm x 160cm. Apenas 8 meses de uso.',
    date: '2023-08-15',
    category: 'furniture',
    isPromoted: true,
    seller: {
